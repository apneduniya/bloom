...
import { createDataSource, createDefaultLayer, createId } from "@/lib/persistence/store";
import {
  useBloomQuery,
  useCurrentUserQuery,
  useSaveBloomDataSourceMutation,
...
import type { Bloom, TextLayer } from "@/lib/validation/types";
import { exportBloomPng } from "@/lib/export/png";
...
function EditorWorkspaceLoaded({ initialBloom }: { initialBloom: Bloom }) {
  ...
  const saveDataSourceMutation = useSaveBloomDataSourceMutation();
